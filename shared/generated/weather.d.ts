...
export function encodeGetWeatherRequest(
...
function _encodeGetWeatherRequest(
  message: GetWeatherRequest,
  bb: ByteBuffer
): void {
...
export function encodeGetWeatherResponse(
...
function _encodeGetWeatherResponse(
  message: GetWeatherResponse,
  bb: ByteBuffer
): void {
...
export function decodeGetWeatherResponse(
  binary: Uint8Array
): GetWeatherResponse {
