...
export function encodeSubscriptionProto(
...
function _encodeSubscriptionProto(
  message: SubscriptionProto,
  bb: ByteBuffer
): void {
...
function _decodeSubscriptionProto(bb: ByteBuffer): SubscriptionProto {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // required bool confirmed = 6;
      case 6: {
        message.confirmed = !!readByte(bb);
        break;
      }

      // required string createdAt = 7;
      case 7: {
        message.createdAt = readString(bb, readVarint32(bb));
        break;
      }

      // required string updatedAt = 8;
      case 8: {
        message.updatedAt = readString(bb, readVarint32(bb));
        break;
      }
  ...
  if (message.id === undefined) throw new Error("Missing required field: id");
  ...
  if (message.frequency === undefined)
    throw new Error("Missing required field: frequency");

  if (message.token === undefined)
    throw new Error("Missing required field: token");

  if (message.confirmed === undefined)
    throw new Error("Missing required field: confirmed");
...
export function encodeSendEmailsRequest(
...
function _encodeSendEmailsRequest(
  message: SendEmailsRequest,
  bb: ByteBuffer
): void {
  ...
  if (array$subscription !== undefined) {
    for (let value of array$subscription) {
      writeVarint32(bb, 10);
      let nested = popByteBuffer();
      _encodeSubscriptionProto(value, nested);
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 1: {
        ...
        let values = message.subscription || (message.subscription = []);
        values.push(_decodeSubscriptionProto(bb));
        bb.limit = limit;
        break;
      }
...
export function encodeSendEmailsResponse(
...
function _encodeSendEmailsResponse(
  message: SendEmailsResponse,
  bb: ByteBuffer
): void {}

export function decodeSendEmailsResponse(
  binary: Uint8Array
): SendEmailsResponse {
...
export function encodeSendConfirmationEmailRequest(
...
function _encodeSendConfirmationEmailRequest(
  message: SendConfirmationEmailRequest,
  bb: ByteBuffer
): void {
  ...
  if ($subscription !== undefined) {
    writeVarint32(bb, 10);
    let nested = popByteBuffer();
    _encodeSubscriptionProto($subscription, nested);
    writeVarint32(bb, nested.limit);
    writeByteBuffer(bb, nested);
    pushByteBuffer(nested);
  }
...
export function decodeSendConfirmationEmailRequest(
  binary: Uint8Array
): SendConfirmationEmailRequest {
  return _decodeSendConfirmationEmailRequest(wrapByteBuffer(binary));
}

function _decodeSendConfirmationEmailRequest(
  bb: ByteBuffer
): SendConfirmationEmailRequest {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 1: {
        let limit = pushTemporaryLength(bb);
        message.subscription = _decodeSubscriptionProto(bb);
        bb.limit = limit;
        break;
      }
  ...
  if (message.subscription === undefined)
    throw new Error("Missing required field: subscription");
...
export function encodeSendEmailConfirmationResponse(
...
function _encodeSendEmailConfirmationResponse(
  message: SendEmailConfirmationResponse,
  bb: ByteBuffer
): void {}

export function decodeSendEmailConfirmationResponse(
  binary: Uint8Array
): SendEmailConfirmationResponse {
  return _decodeSendEmailConfirmationResponse(wrapByteBuffer(binary));
}

function _decodeSendEmailConfirmationResponse(
  bb: ByteBuffer
): SendEmailConfirmationResponse {
